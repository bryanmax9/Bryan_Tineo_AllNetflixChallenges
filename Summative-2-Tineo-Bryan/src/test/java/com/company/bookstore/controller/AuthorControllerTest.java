...
public class AuthorControllerTest {
    ...
    public void testAddAuthor() throws Exception {
        // Create a new Author object to be added
        // Create a test Author object
        testAuthor = new Author();
        testAuthor.setId(1);
        testAuthor.setFirstName("John");
        testAuthor.setLastName("Doe");
        testAuthor.setStreet("123 Main St");
        testAuthor.setCity("Anytown");
        testAuthor.setState("CA");
        testAuthor.setPostalCode("12345");
        testAuthor.setPhone("555-123-4567");
        testAuthor.setEmail("johndoe@example.com");
        testAuthor.setBookId(0);

        String inputJson = mapper.writeValueAsString(testAuthor);
